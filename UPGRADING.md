...
* Added `--mode` flag and `mode` config variable on `config.toml` for setting Mode of the Node: `full` | `validator` | `seed` (default: `full`)
  [ADR-52](https://github.com/HighStakesSwitzerland/tendermint/blob/master/docs/architecture/adr-052-tendermint-mode.md)
...
* We have added a new, experimental tool to help operators migrate
  ...
  ```shell
  # Install the tool.
  go install github.com/HighStakesSwitzerland/tendermint/scripts/confix@v0.35.x
...
`github.com/HighStakesSwitzerland/tendermint/scripts/keymigrate/migrate.go` provides the
...
`github.com/HighStakesSwitzerland/tendermint/rpc/client/local` package and pass
...
* The [`PublicKey` type](https://github.com/HighStakesSwitzerland/tendermint/blob/master/proto/tendermint/crypto/keys.proto#L13-L15)
...
* The `state` package now has a `Store` interface. All functions in
  [state/store.go](https://github.com/HighStakesSwitzerland/tendermint/blob/56911ee35298191c95ef1c7d3d5ec508237aaff4/state/store.go#L42-L42)
...
[here](https://github.com/HighStakesSwitzerland/tendermint/pull/3668).
...
keys are called
[compositeKeys](https://github.com/HighStakesSwitzerland/tendermint/blob/6d05c531f7efef6f0619155cf10ae8557dd7832f/docs/app-dev/indexing-transactions.md).
...
For further documentation on `Events`, see the [docs](https://github.com/HighStakesSwitzerland/tendermint/blob/60827f75623b92eff132dc0eff5b49d2025c591e/docs/spec/abci/abci.md#events).
...
* [Merkle tree](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/blockchain/encoding.md#merkle-trees)
* [ConsensusParams](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/blockchain/state.md#consensusparams)

There was also a small change to field ordering in the vote struct. Any
implementations of an out-of-process validator (like a Key-Management Server)
will need to be updated. For specific details:

* [Vote](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/consensus/signing.md#votes)

Finally, the proposer selection algorithm continues to evolve. See the
[work-in-progress
specification](https://github.com/HighStakesSwitzerland/tendermint/pull/3140).
...
See [#3105](https://github.com/HighStakesSwitzerland/tendermint/issues/3105).
Note the Unix socket has neither encryption nor authentication, but will
add a shared-secret in [#3099](https://github.com/HighStakesSwitzerland/tendermint/issues/3099).
...
* [ADR-026](https://github.com/HighStakesSwitzerland/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/architecture/adr-026-general-merkle-proof.md)
* [Relevant ABCI
  documentation](https://github.com/HighStakesSwitzerland/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/spec/abci/apps.md#query-proofs)
* [Description of
  keys](https://github.com/HighStakesSwitzerland/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/crypto/merkle/proof_key_path.go#L14)
...
[here](https://github.com/HighStakesSwitzerland/tendermint/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/cmd/tendermint/commands/run_node.go#L60).
