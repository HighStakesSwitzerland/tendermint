...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/HighStakesSwitzerland/tendermint/cmd/tendermint/commands"
    * tmcfg "github.com/HighStakesSwitzerland/tendermint/config/tendermint"
    * tmtypes "github.com/HighStakesSwitzerland/tendermint/types"
...
* When importing a pkg from the `tendermint/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/HighStakesSwitzerland/tendermint/libs/bits"
