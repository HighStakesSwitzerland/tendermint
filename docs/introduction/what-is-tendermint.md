...
(ABCI)](https://github.com/HighStakesSwitzerland/tendermint/tree/master/abci)
...
Types](https://github.com/HighStakesSwitzerland/tendermint/blob/master/abci/README.md#message-types).
