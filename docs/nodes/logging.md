...
- `abci-client` As mentioned in [Application Architecture Guide](../app-dev/app-architecture.md), Tendermint acts as an ABCI
  ...
  be found [here](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/abci/client).
...
- `consensus` The heart of Tendermint core, which is the
  ...
  from a crash.
  [here](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/types/events.go).
...
- `rpc-server` RPC server. For implementation details, please read the
  [doc.go](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/rpc/jsonrpc/doc.go).
...
Algorithm](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/consensus/consensus.md).
