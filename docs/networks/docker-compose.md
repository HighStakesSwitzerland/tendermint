...
To use your own ABCI applications with 4-node setup edit the [docker-compose.yaml](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/docker-compose.yml) file and add image to your ABCI application.
...
Override the [command](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/networks/local/localnode/Dockerfile#L12) in each node to connect to it's ABCI.
