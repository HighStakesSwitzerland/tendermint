...
definition](https://github.com/HighStakesSwitzerland/tendermint/blob/master/types/genesis.go)).
...
- `consensus_params` [spec](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/core/state.md#consensusparams)
    - `block`
...
See the
[UPGRADING.md](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/UPGRADING.md)
