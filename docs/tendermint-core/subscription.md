...
[List of events](https://godoc.org/github.com/HighStakesSwitzerland/tendermint/types#pkg-constants)
...
section](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/abci/abci.md#endblock) in
the ABCI spec).
