...
import (
	...
	clist "github.com/HighStakesSwitzerland/tendermint/internals/libs/clist"
...
func (r *Reactor) handleEvidenceMessage(envelope p2p.Envelope) error {
	...
	case *tmproto.EvidenceList:
		...
		// batching evidence.
		//
		// see: https://github.com/HighStakesSwitzerland/tendermint/issues/4729
...
//
// REF: https://github.com/HighStakesSwitzerland/tendermint/issues/4727
