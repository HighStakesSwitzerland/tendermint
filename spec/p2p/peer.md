...
For details on peer discovery, see the [peer exchange (PEX) reactor doc](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/reactors/pex/pex.md).
