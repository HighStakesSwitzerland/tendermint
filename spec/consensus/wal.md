...
Make sure to read about [WAL corruption](https://github.com/HighStakesSwitzerland/tendermint/blob/master/docs/tendermint-core/running-in-production.md#wal-corruption)
