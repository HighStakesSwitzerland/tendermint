...
Types](https://github.com/HighStakesSwitzerland/tendermint/blob/master/types/genesis.go).
...
[light client attack](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/light-client/detection/detection_003_reviewed.md#tmbc-lc-attack1)
and not just a [bogus](https://github.com/HighStakesSwitzerland/tendermint/blob/v0.35.x/spec/light-client/detection/detection_003_reviewed.md#tmbc-bogus1) block could result in
