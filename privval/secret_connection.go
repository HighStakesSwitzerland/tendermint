...
import (
	...
	"github.com/HighStakesSwitzerland/tendermint/libs/async"
	tmprivval "github.com/HighStakesSwitzerland/tendermint/proto/tendermint/privval"
)
...
// https://github.com/HighStakesSwitzerland/tendermint/issues/4698
...
// See https://github.com/HighStakesSwitzerland/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/HighStakesSwitzerland/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/HighStakesSwitzerland/tendermint/issues/3531
